...
class CommentLike(models.Model):
    user = models.ForeignKey(get_user_model(), related_name='comment_likes', on_delete=models.CASCADE, verbose_name='Пользователь')
    ...
    class Meta:
        verbose_name = 'Лайк'
        verbose_name_plural = 'Лайки комментарии'
